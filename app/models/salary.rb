class Salary < ActiveRecord::Base
  ...
  attr_accessible :basic_paisas, :da_paisas, :employeesalary_paisas, :hra_paisas, :ca_paisas, :sa_paisas, :effective_from, :effective_to, :employee_id, :experience_allowance_paisas, :attendances_attributes, :deductions_attributes, :employee_attributes 
